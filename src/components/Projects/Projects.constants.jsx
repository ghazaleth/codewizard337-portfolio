...
export const web = [
	...
	},
	{
		...
		links: [
			// { icon: gitLink, link: 'https://github.com/codewizard337/Top-three-crypto' },
	...
	},
	{
		...
		cover: navui,
		links: [
			{ icon: gitLink, link: 'https://github.com/codewizard337/Navigation-menu-animation' },
	...
	},
	{
		...
		cover: btnanim,
		links: [
			{ icon: gitLink, link: 'https://github.com/codewizard337/Comic-book-button-anim' },
	...
	},
	{
		...
		cover: dynamicmenu,
		links: [
			// { icon: gitLink, link: 'https://github.com/codewizard337/dynamic-menu' },
